...
with st.sidebar:
    ...
    thread_id = st.text_input("👤 User ID", value="Roshan",
    ...
    for step in ["① Flight Agent", "② Hotel Agent", "③ Train Agent", "④ Itinerary Agent", "⑤ Final Agent"]:
...
<div class="hero-wrapper">
    ...
    <div class="hero-content">
        ...
        <div class="hero-title">✈️ AI Travel Planner System</div>
...
cols = st.columns(5)
for col, (name, img_url) in zip(cols, [
...
cols = st.columns(4)
for name, img_url in [
    ("🏛️ Varanasi",           "https://imgs.search.brave.com/xeDu9-aoP9sFnIrA-syGZE-dWxzzg47cXadn-vKZTHg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9oYmxp/bWcubW10Y2RuLmNv/bS9jb250ZW50L2h1/YmJsZS9pbWcvZGVz/dHR2aW1nL21tdC9k/ZXN0aW5hdGlvbi9t/X3ZhcmFuYXNpX3R2/X2Rlc3RpbmF0aW9u/X2ltZ18xX2xfOTYw/XzE0MzAuanBn"),
    ("⛰️ Kashmir",            "https://imgs.search.brave.com/4IAgpwi_ZX9pYLCOWUnZb4EIyrZUlJYw5pzZoCR3DkQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/d29ybGRhdGxhcy5j/b20vdXBsb2FkLzcw/LzMzL2FiL3NodXR0/ZXJzdG9jay0xMTUy/Mjc0NzUuanBn"),
    ("🌲 Pachmarhi",          "https://imgs.search.brave.com/wEIGd5_puLp6VOaP3C-MubEhsGD1UX8wX2vprH9HiKc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA3LzIwLzUxLzAx/LzM2MF9GXzcyMDUx/MDExMl82dWFQeE9w/VThLS3Rtb1BPNnBI/Z09BMjhpblJkSjV2/ZS5qcGc"),
    ("🏞️ Lonavala",           "https://imgs.search.brave.com/j_IVCbjkAW0kp8OLSZDbPudute0mARgaee0nxBizy6E/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/cGF3bmFsYWtlY2Ft/cGluZy5uZXQvd3At/Y29udGVudC91cGxv/YWRzLzIwMjMvMDQv/cmFqbWFjaGkuanBn"),
    ("🏖️ Goa",                "https://imgs.search.brave.com/Ov3-D-QEQ1wB1KrPC_ljqkaXmQERZA7s8PJwSVcrG5Q/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzAzLzQ0Lzg5LzI0/LzM2MF9GXzM0NDg5/MjQyOF9KWnNHVUpR/VEgyRHVkdG5nMzU5/ZHRyMWRheU1IZjFp/by5qcGc"),
    ("🏰 Jaipur",             "https://imgs.search.brave.com/ERKEcWLjiFtPj5y7HyEcyTA1sz3cKVlX9shxdnUEbrA/rs:fit:860:0:0:0/g:"),
    ("🌴 Backwaters",         "https://imgs.search.brave.com/vI2vN7HKtNzLdyKfOZQ8oXv5NmrbTUo3DkJcr-pCRms/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzE4Lzk3LzUxLzQ0/LzM2MF9GXzE4OTc1/MTQ0NDZfamk3STk0/ZTdJSEJyNjZwcXFp/ZUVUSnJXVGdYWEhN/alYuanBn"),
    ("🌄 Darjeeling",         "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&q=70"),
]:
    if col_idx >= 4:
        cols = st.columns(4)
        col_idx = 0
    ...
    with cols[col_idx]:
        st.markdown(f"""
        <div style="border-radius:10px;overflow:hidden;position:relative;height:90px;cursor:pointer; margin-bottom:20px;">
            <img src="{img_url}" style="width:100%;height:100%;object-fit:cover;filter:brightness(0.55);" />
            <div style="position:absolute;bottom:8px;left:0;right:0;text-align:center;
                        color:#fff;font-size:0.8rem;font-weight:600;">{name}</div>
        </div>
...
QUICK = ["7-day Japan under ₹2L", "Varanasi trip for 5 days", "Goa weekend trip", "Paris for 10 days"]
qcols = st.columns(len(QUICK))

# Use session state to persist the selected quick trip across reruns
...
for qc, label in zip(qcols, QUICK):
    with qc:
        if st.button(label, key=f"q_{label}"):
            st.session_state.selected_trip = label
            st.rerun()

user_query = st.text_area(
    label="Trip description",
    value=st.session_state.selected_trip,
...
if generate:
    if not user_query.strip():
        ...
        collected = {"flight_results": "", "train_results": "", "hotel_results": "",
            ...
            for node_name, state_update in chunk.items():
                ...
                with st.status(f"{icon}  {label}", state="complete", expanded=True):
                    if node_name == "flight_agent":
                        ...
                        text = state_update.get("train_results", "")
                        collected["train_results"] = text
                        st.markdown(text or "_No train travel data returned._")
                    elif node_name == "itinerary_agent":
                        text = state_update.get("itinerary", "")
                        collected["itinerary"] = text
                        st.markdown(text or "_No itinerary generated._")
                    elif node_name == "final_agent":
                        text = state_update.get("final_response") or ""
                        if not text:
...
## 🚆 Train Information
{collected['train_results'] or 'N/A'}
